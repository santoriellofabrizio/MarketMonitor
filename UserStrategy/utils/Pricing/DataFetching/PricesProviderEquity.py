...
from UserStrategy.utils.Pricing.DataFetching.PricesProvider import PricesProvider
from UserStrategy.utils.Pricing.DataFetching.download_functions import process_downloaded_prices, \
